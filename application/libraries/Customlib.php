...
class Customlib
{
    ...
    {
        $coursetype = array();
        $coursetype['theory']    = $this->CI->lang->line('theory');
        $coursetype['practical'] = $this->CI->lang->line('practical');
        return $coursetype;
    }    
    ...
    public function getDaysname()
    {
        ...
        //tukar senarai hari dalam minggu kat sini..
        $end   = $start + (86400 * 5);
 ...
 public function get_betweendate($search_type)
    ...
    public function get_postmessage()
    {
        ...
        if (isset($_POST['course_id']) && $_POST['course_id'] != '') {
            $filter_record['course_id'] = $this->CI->messages_model->get_course_name($_POST['course_id']);
        }        
