...
<div class="content-wrapper">
    <section class="content-header">
        <h1> <i class="fa fa-user-plus"></i>
            <?php echo $this->lang->line('student_information'); ?><small><?php echo $this->lang->line('student1'); ?></small>
        </h1>
    </section>
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary"> <div class=""> <div class="pull-right box-tools"> </div> </div>
                    ...
                    <div class="box-body">
                        <div class="tshadow mb25 bozero">
                            <h3 class="pagetitleh2">
                                <?php echo $this->lang->line('edit'); ?> <?php echo $this->lang->line('student'); ?>
                            </h3>
                            <div class="around10">
                                ...
                                <div class="row">
                                    ...
                                    <?php } if ($sch_setting->category) { ?>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('courses'); ?></label><small class="req"> *</small>
                                                <select  id="category_id" name="category_id" class="form-control" >
                                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                    <?php foreach ($categorylist as $category) { ?>
                                                        <option value="<?php echo $category['id'] ?>"
                                                            <?php if ($student['category_id'] == $category['id']) {
                                    ...
                                    <div class="row">
                                        ...
                                        <?php if ($sch_setting->roll_no) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('nric'); ?></label>
                                        ...
                                        <div class="radio" style="margin-top: 2px;">
                                            <label> <input class="radio-inline" type="radio" name="gender" value="Male"
                                             <?php echo set_value('gender', $student['gender']) == "Male" ? "checked" : "";?> ><?php echo $this->lang->line('male'); ?>
                                         </label>
                                         <label> <input class="radio-inline" type="radio" name="gender" value="Female"
                                             <?php echo set_value('gender', $student['gender']) == "Female" ? "checked" : ""; ?> > <?php echo $this->lang->line('female'); ?>
                                         </label>
                                     </div>
                             ...
                             <div class="row">
                                ...
                                <?php } if ($sch_setting->religion) { ?>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1"><?php echo $this->lang->line('race'); ?></label>
                                            ...
                                            <span class="text-danger"><?php echo form_error('race'); ?></span>
                                        </div>
                                    </div>
                                <?php } if ($sch_setting->mobile_no) { ?>
                                    ...
                                    <?php if ($sch_setting->ifsc_code) { ?>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('mobile_no2'); ?></label>
                                ...
                                <?php if ($sch_setting->previous_school_details) { ?>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="" name="previous_school"><?php echo set_value('previous_school', $student['previous_school']); ?></textarea>
                            ...
                            <div class="row">
                                ...
                                <?php }if ($sch_setting->guardian_address) { ?>
                                    <div class="col-md-6">
                                        ...
                                        <input id="guardian_address" name="guardian_address" placeholder="" class="form-control" value="<?php echo set_value('guardian_address', $student['guardian_address']); ?>">
