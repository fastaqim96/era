...
<div class="content-wrapper">
    ...
    <section class="content">
                    ...
                    <table class="table table-striped table-bordered table-hover student-list" data-export-title="<?php echo $this->lang->line('student') . " " . $this->lang->line('list'); ?>">
                        <thead>
                            <tr>
                                ...
                                <th style="min-width: 200px"><?php echo $this->lang->line('student_name'); ?></th>
                                <th style="min-width: 130px"><?php echo $this->lang->line('class'); ?></th>
                                        ...
                                        <div class="carousel-inner">
                                            <div class="item active">
                                                <a href="<?php echo base_url(); ?>student/view/<?php echo $student['id'] ?>">
                                                    <?php if ($sch_setting->student_photo) {?><img class="img-responsive img-thumbnail width150" alt="<?php echo $student["firstname"] . " " . $student["lastname"] ?>" src="<?php echo base_url() . $image; ?>" alt="Image"><?php }?>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
        ...
        </div><!--./nav-tabs-custom border0 navnoshadow -->
    </div><!--./box box-primary -->
    <?php //  } ?>
</div>
</div>
